"""
Optimize NL2PLNModule with BootstrapFewShot, starting from bootstrap-generated
content (conversion_guidelines.txt as instruction, chainer_analysis.txt as
pln_spec).
...
when you already have a strong instruction (which we now do from the
bootstrap pipeline) and just want to layer battle-tested demos on top
without disturbing the carefully-engineered prompt.
...
# --------------------------------------------------------------------------- #
#  LM choices previously tried (pass any LiteLLM id via --model):             #
#   openai/gpt-5.4-mini                                                       #
#   openai/gpt-5.2                                                            #
